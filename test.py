...
upgrade_bgd = transform.scale(image.load(UPGRADE_BGD), (900, 400))
rules = transform.scale(image.load(RULES), (SCREEN_HEIGHT - 10, SCREEN_HEIGHT - 10))
counter = transform.scale(image.load(COUNTER), (160, 40))
health2 = transform.scale(image.load(HEALTH2), (40, 40))
...
if choice(pos_list) == pos1:
    for p in pos1:
        x = 900
        for i in p:
            if pos1.index(p) == 0 and i == 1:
                box = Objects(BOX, x, UP, 60, 60, x, UP)
                boxes.append(box)
            elif pos1.index(p) == 1 and i == 1:
               box = Objects(BOX, x, CENTER, 60, 60, x, CENTER)
               boxes.append(box)
            elif pos1.index(p) == 2 and i == 1:
    ...
    for p in pos1:
        x = 900
        for i in p:
            if pos1.index(p) == 0 and i == 2:
                coin = Objects(COIN, x, CENTER, 30, 30, x, UP + 30)
                coins.append(coin)
            elif pos1.index(p) == 2 and i == 2:
    ...
    for p in pos2:
        x = 900
        for i in p:
            if pos2.index(p) == 0 and i == 1:
                box = Objects(BOX, x, UP, 60, 60, x, UP)
                boxes.append(box)
            elif pos2.index(p) == 1 and i == 1:
               box = Objects(BOX, x, CENTER, 60, 60, x, CENTER)
               boxes.append(box)
            elif pos2.index(p) == 2 and i == 1:
                box = Objects(BOX, x, DOWN, 60, 60, x, DOWN-90)
                boxes.append(box)
            x += 90
    for p in pos2:
        x = 900
        for i in p:
            if pos2.index(p) == 0 and i == 2:
                coin = Objects(COIN, x, CENTER, 30, 30, x, UP + 30)
                coins.append(coin)
            elif pos2.index(p) == 2 and i == 2:
                coin = Objects(COIN, x, CENTER, 30, 30, x, CENTER)
                coins.append(coin)
            elif pos2.index(p) == 2 and i == 2:
                coin = Objects(COIN, x, CENTER, 30, 30, x, DOWN - 130)
